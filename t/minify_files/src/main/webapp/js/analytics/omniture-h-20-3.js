...
s.trackingServer='metrics.peacocks.co.uk';
s.trackingServerSecure='smetrics.peacocks.co.uk';
//s.visitorNamespace=<<domain>>;

/* Site Config */
s.gmt='+0'; // Used for time parting, set for client's time zone
s.cookieDomainPeriods='3';

/* Variable Mapping */
s.varMap['Tracking Code Conversion'] = 'campaign';
s.varMap['Tracking Code Cross Visit Participation Conversion'] = 'eVar23';
s.varMap['Referring Domain Cross Visit Participation Conversion'] = 'eVar38';
...
s.externalCampaignParams = 'cid,camp,cmpid';
