...
$(document).observe('dom:loaded', function(e){
    ...
    /**
     * PEAC Express Shop implementation
     *
     * @requires Store.js
    ...
    Store.expressShop = Class.create(Store.ES, {
	   ...
	   buildQuantitybox: function(e){
           ...
           // Quantity validation
           ess.validateQuantityOnKeyUp("#esmc-qty", 999, function(qty){
               this.productState.setQuantity(qty);
           }.bind(this));
       },
    ...
    if (ess.configuration && ess.configuration.expressShopEnabled) {
        if ($('products')) {
            window.es = new Store.expressShop($('products').e('div', 'bottom', {id:'ins1'}).addClassName('express-shop').hide());
        }
    }
