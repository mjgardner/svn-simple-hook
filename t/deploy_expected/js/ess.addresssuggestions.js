...
ess.addresssuggestions.onAddressChange = function(e, addressType, addressTypePrefix){
    ...
    /*
    alert('----- ess.addresssuggestions.onAddressChange -----'
      + '\n' + 'e = ' + e + '\n' + 'addressType = ' + addressType + '\n' + 'addressTypePrefix = ' + addressTypePrefix
      + '\n' + '\n' + 'suggestions = ' + suggestions
      + '\n' + '\n' + '$(addressType + \'.address.honorific\').value = ' + $(addressType + '.address.honorific').value
      + '\n' + '$(addressType + \'.address.firstName\').value = ' + $(addressType + '.address.firstName').value
      + '\n' + '$(addressType + \'.address.lastName\').value = ' + $(addressType + '.address.lastName').value
      + '\n' + '$(addressType + \'.address.businessName\').value = ' + $(addressType + '.address.businessName').value
      + '\n' + '$(addressType + \'.address.address1\').value = ' + $(addressType + '.address.address1').value
      + '\n' + '$(addressType + \'.address.address2\').value = ' + $(addressType + '.address.address2').value
      + '\n' + '$(addressType + \'.address.address3\').value = ' + $(addressType + '.address.address3').value
      + '\n' + '$(addressType + \'.address.city\').value = ' + $(addressType + '.address.city').value
      + '\n' + '$(addressType + \'.address.state\').value = ' + $(addressType + '.address.state').value
      + '\n' + '$(addressType + \'.address.postalCode\').value = ' + $(addressType + '.address.postalCode').value
      + '\n' + '$(addressType + \'.address.country\').value = ' + $(addressType + '.address.country').value
      + '\n' + '$(addressType + \'.phone\').value = ' + $(addressType + '.phone').value);
    */
}
...
ess.addresssuggestions.addressSuggestionBindListeners = function(){
	if($('billingSuggOption0')){
        $$("input[name=billingSuggOption]").each(function(v){
            /* alert('----- ess.addresssuggestions.addressSuggestionBindListeners -----' + '\n' + 'billingSuggOption0' + '\n' + 'v.id = ' + v.id); */
...
document.observe("dom:loaded", function(e){
	/* alert('----- dom:loaded: ess.addresssuggestions.js -----' + '\n' + 'ess.addresssuggestions.suggestions = ' + ess.addresssuggestions.suggestions); */
