...
// Omniture account is set via the Df.Analytics library
var s=s_gi('')
s.varMap = {}
/************************** CONFIG SECTION **************************/
/* Tracking Server Config */
s.trackingServer='metrics.timberland.com';
s.trackingServerSecure='smetrics.timberland.com';
s.visitorNamespace='timberland';
...
s.varMap['Tracking Code Cross Visit Participation Conversion'] = 'eVar39';
s.varMap['Referring Domain Cross Visit Participation Conversion'] = 'eVar34';
s.varMap['External Campaign Page Traffic'] = 'prop7';
s.varMap['Internal Campaign Performance Conversion'] = 'eVar1';
s.varMap['Internal Campaign Page Traffic'] = 'prop12';
s.varMap['Hour of Day Conversion'] = 'eVar24';
s.varMap['Day of Week Conversion'] = 'eVar25';
s.varMap['New vs Repeat Visitors Conversion'] = 'eVar22';
s.varMap['New vs Repeat Visitors Traffic'] = 'prop5';
s.varMap['Referring Pages Conversion'] = 'eVar27';
...
function s_doPlugins(s)
{
  ...
  if (internalCampaignTrackingCodes) {
    s[s.varMap['Internal Campaign Performance Conversion']] = s.getAndPersistValue(internalCampaignTrackingCodes,'s_internalCampaignTrackingCodes',0);
  }
  ...
  if (referringDomain) {
    ...
    if (s.linkInternalFilters) {
        ...
        $A(internalDomains).each(function(domain) {
          if (referringDomain.indexOf(domain) > 0) {
            isExternalReferrer = false;
          }
        });
    }
    if (isExternalReferrer) {
      s[s.varMap['Referring Domain Cross Visit Participation Conversion']] =
	  s.crossVisitParticipation(referringDomain , 's_rdcvpc', '30', '5', ' > ', 'purchase');
    }
  }
  ...
  /* Null Product and Null events String Handler */
  if (!s.products || !s.events) {
    s.products=';';
  }
//eVar37 is added for TBL Email Recipient Id
  if(!s.eVar37)
		s.eVar37=s.getQueryParam('cm_rid');
...
Object.extend(String.prototype, {
	...
	return this.replace(/([^A-Z])([A-Z])/g,"$1 $2").replace(/([A-Z])(?=[^A-Z])/g," $1").replace(/-/g, ' ').replace(/(^\s)/g,"").replace(/[\s]+/g, '_').toUpperCase()
    }
})
...
Df.AnalyticsLibrary = function(){
	...
	//Email A Product
	EmailAProduct: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Product Detail',
                pageTitle: 'Email a Product',
                localizedPageType: 'Product Detail',
                localizedPageTitle: 'Email a Product'
	    })
	    _r.addEvent('AnalyticsDefaultEventType', 'EmailAProductEvent')
	    _r.send()
	},
	
	//Email Wishlist
	EmailWishlist: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Wishlist',
                pageTitle: 'Email a Wishlist',
                localizedPageType: 'Wishlist',
                localizedPageTitle: 'Email a Wishlist'
	    })
	    //_r.addEvent('TumiAnalyticsEventType', 'TumiEmailWishlistEvent')
	    _r.send()
	},

	//Email Wishlist Thanks
	EmailWishlistThanks: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Wishlist',
                pageTitle: 'Email a Wishlist Thanks Page',
                localizedPageType: 'Wishlist',
                localizedPageTitle: 'Email a Wishlist Thanks Page'
	    })
	    //_r.addEvent('TumiAnalyticsEventType', 'TumiEmailWishlistEvent')
	    _r.send()
	},
	...
	GiftCardBalanceLookup: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Gift Card Balance Lookup',
                pageTitle: '',
                localizedPageType: 'Gift Card Balance Lookup',
                localizedPageTitle: ''
	    })
	    _r.send()
	},

	//Gift Card Balance Lookup Thanks
	GiftCardBalanceLookupThanks: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Gift Card Balance Lookup Thanks',
                pageTitle: '',
                localizedPageType: 'Gift Card Balance Lookup Thanks',
                localizedPageTitle: ''
	    })
	    _r.send()
	},
	...
	//Comparison Grid
	ComparisonGrid: function(e){
	    _r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Comparison Grid',
                pageTitle: '',
                localizedPageType: 'Comparison Grid',
                localizedPageTitle: ''
	    })
	    _r.send()
	},
	...
	//Read Review
	ReadReview: function(e){
		_r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                pageType: 'Read Review',
                pageTitle: '',
                localizedPageType: 'Read Review',
                localizedPageTitle: ''
	    })
		
		var o = {};
		var p = Df.AnalyticsLibrary._getAnalyticsProduct(e);
		o.product = p;
		_r.addEvent('AnalyticsDefaultEventType', 'ReadReviewEvent', o);
	    _r.send()
	},
	...
	ExpressShopAddToCart: function(e) {
	    ...
	    } else if (e.memo.cartAddSrc == "PCSD") {
	    	o.cartAdditionSource = 'Product Cross Sells';
	    } else {
	    	o.cartAdditionSource = 'Express Shop';
	    }
	...
	ExpressShopEditInCart: function(e) {
		_r.addEvent('AnalyticsDefaultEventType', 'PageViewEvent', {
                ...
                pageTitle: '',
                localizedPageType: 'Shopping Bag',
                localizedPageTitle: ''
	    })

		var o = Df.AnalyticsLibrary._getAnalyticsOrderItem(e);
